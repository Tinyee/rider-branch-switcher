...
- 282 测试 / 21 个测试类（JUnit 4 + Kotest 属性测试）
...
| P1 | **单元测试**:GitOps / SwitchExecutor 都没有。mock GitOps 跑 SwitchExecutor 至少覆盖「主仓成功子模块失败」的 case | ✅ 282 用例, mock GitClient, cmd 可跑 |
...
- ✅ 282 测试，21 个测试类，`./gradlew test` 即可跑
