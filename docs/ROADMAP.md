...
- 309 测试 / 30 个测试类（159 个 core pure JVM + 150 个平台/集成；含 4 个 Kotest 属性测试，不含 benchmark）
...
- ✅ 309 测试，30 个测试类：`./gradlew :core:test` 跑 159 个 core 纯 JVM 测试，`./gradlew :test` 跑 150 个平台/集成测试
