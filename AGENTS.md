...
./gradlew pureTest      # alias for :core:test; 62 core pure JVM tests, no IntelliJ Platform test runtime
./gradlew test          # 225 platform/integration tests / 12 classes
...
- 287 tests / 21 classes 覆盖：62 个 core pure JVM 测试 + 225 个平台/集成测试，含真实 Git 集成、取消、rollback、derive 安全、通知决策、stash+rollback、50 子模块调用预算。
