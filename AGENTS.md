...
- **测试**: 302 tests / 21 classes, `./gradlew test`
- **版本**: 0.7.0
...
./gradlew test          # 302 tests / 21 classes
...
- 302 tests / 21 classes 覆盖：真实 Git 集成、取消、rollback、derive 安全、通知决策、stash+rollback、50 子模块调用预算。
