...
- **测试**: 286 tests / 20 classes, `./gradlew test`
- **版本**: 0.7.0
...
./gradlew test          # 286 tests / 20 classes
...
- 286 tests / 20 classes 覆盖：真实 Git 集成、取消、rollback、derive 安全、通知决策、stash+rollback、50 子模块调用预算。
