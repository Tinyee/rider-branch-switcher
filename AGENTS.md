...
./gradlew pureTest      # alias for :core:test; 32 core pure JVM tests, no IntelliJ Platform test runtime
./gradlew test          # 255 platform/integration tests / 15 classes
...
- 287 tests / 21 classes 覆盖：32 个 core pure JVM 测试 + 255 个平台/集成测试，含真实 Git 集成、取消、rollback、derive 安全、通知决策、stash+rollback、50 子模块调用预算。
