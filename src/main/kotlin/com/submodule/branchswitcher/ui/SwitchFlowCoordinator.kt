 ...
 * .meta collisions are always included (regenerated by Unity); any other file only when
 ...
 */
fun resolveCollisionDiscards(probeResult: List<PreflightRow>, onlyMeta: Boolean): Map<String, Set<String>> =
    probeResult
